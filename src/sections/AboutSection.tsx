...
import LuizLealsImageLight from "@/assets/images/image-round-luiz-leal-light.png";
import LuizLealsImageDark from "@/assets/images/image-round-luiz-leal-dark.png";
            ...
            <div className="max-w-6xl mx-auto flex flex-col gap-8 md:flex-row md:gap-10 lg:gap-16 items-center md:justify-center">
                <motion.div {...fadeInLeft(20, 0, 1)}>
                    <Image
                        ...
                        alt="Imagem de Luiz Leal"
                        className="w-72 md:w-80 drop-shadow-md animate-moving"
                    />
                </motion.div>
                <motion.article
                    {...fadeInLeft(20, 0.2, 1)}
                ...
                >
                    ...
                    <p>
                        {" "}
                        Me chamo Luiz André Leal, tenho 18 anos, sou programador
                        e técnico em informática. Atualmente estou me
                        especializando em desenvolvimento de aplicativos android
                        nativos, mas tenho experiência também em desenvolvimento
                        web front-end e back-end. Sempre busco aprender novas
                        coisas e aprimorar meus conhecimentos 🧠💪.
                    </p>
                </motion.article>
            </div>
        </main>
